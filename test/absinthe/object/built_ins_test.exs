defmodule Absinthe.Object.BuiltInsTest do
  use ExUnit.Case, async: true

  describe "Node interface" do
    alias Absinthe.Object.BuiltIns.Node

    test "defines __absinthe_object_kind__" do
      assert Node.__absinthe_object_kind__() == :interface
    end

    test "defines __absinthe_object_identifier__" do
      assert Node.__absinthe_object_identifier__() == :node
    end

    test "defines __absinthe_object_definition__" do
      definition = Node.__absinthe_object_definition__()
  ...
  describe "Node resolve_type coverage" do
    ...
    defmodule NodeResolveSchema do
      ...
      import_types Absinthe.Object.BuiltIns.Node
  ...
  describe "PageInfo type" do
    alias Absinthe.Object.BuiltIns.PageInfo

    # PageInfo uses Absinthe.Schema.Notation directly, not our wrapper
    # so it doesn't have __absinthe_object_kind__ or __absinthe_object_identifier__
  ...
  describe "Timestampable definition" do
    alias Absinthe.Object.BuiltIns.Timestampable, as: TS

    test "has correct definition values" do
      definition = TS.__absinthe_object_definition__()
      assert definition.kind == :interface
      assert definition.identifier == :timestampable
    end

    test "has correct identifier" do
      assert TS.__absinthe_object_identifier__() == :timestampable
    end

    test "has correct kind" do
      assert TS.__absinthe_object_kind__() == :interface
    end
  end
end
