defmodule GreenFairy.CQL.Scalars.ArrayEnum do
  @moduledoc """
  CQL scalar for enum array fields.
  """
  ...
  def operator_input(adapter) do
    ...
    {operators, :string, "Operators for enum array fields"}
  end
  ...
  @impl true
  def operator_type_identifier(_adapter), do: :cql_op_enum_array_input
end
