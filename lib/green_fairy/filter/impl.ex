defmodule GreenFairy.Filter.Impl do
  @moduledoc """
  ...
  defmacro __using__(opts) do
    ...
    quote do
      import GreenFairy.Filter.Impl, only: [filter_impl: 2]
      ...
      @before_compile GreenFairy.Filter.Impl
    end
  end
  ...
  defmacro filter_impl(filter_module, do: block) do
    ...
    quote do
      ...
      GreenFairy.Filter.register_implementation(
